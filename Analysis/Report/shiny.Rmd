...
```{r}
dat=fread("wines.csv",na.strings=c(""))
```
...
<!-- ```{r} -->
<!-- renderPlot({ -->
<!--   subdat <- dat %>% select(variety.name,country.name,points.name,province.name, winery.name,description.name) -->
<!--   subdat$descriptioncount <- str_count(string = subdat$description, pattern = '\\S+') -->

<!--   wordcloudData <- subdat%>% -->
