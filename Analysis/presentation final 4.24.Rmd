...
Sentiment of descriptioin

  > The distribution of words length roughly shows normal distribution
...
Closer look at description sentiment of different countries.
Sorted country from most recored data to least recorded data and show first 15 countries.
...
Interesting thing with review emotion.

```{r foundation to text analysis warning=FALSE}
# Emotion 
subdat %>%
unnest_tokens(output = word, input = description) %>%
